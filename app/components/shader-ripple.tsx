...
type ShaderRippleUniforms = {
  time: THREE.IUniform<number>;
  resolution: THREE.IUniform<THREE.Vector2>;
  lineWidth: THREE.IUniform<number>;
  rippleCount: THREE.IUniform<number>;
  colorLayers: THREE.IUniform<number>;
  rotation: THREE.IUniform<number>;
  timeScale: THREE.IUniform<number>;
  opacity: THREE.IUniform<number>;
  waveIntensity: THREE.IUniform<number>;
  scale: THREE.IUniform<number>;
  color1: THREE.IUniform<THREE.Vector3>;
  color2: THREE.IUniform<THREE.Vector3>;
  color3: THREE.IUniform<THREE.Vector3>;
  loopDuration: THREE.IUniform<number>;
  modValue: THREE.IUniform<number>;
};
